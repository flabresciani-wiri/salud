...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_conversionId":"804757827",
      "vtp_conversionLabel":"oz8qCKDplqQCEMPC3v8C",
      "vtp_rdp":false,
      "vtp_url":["macro",4],
      "vtp_enableProductReportingCheckbox":true,
      "vtp_enableNewCustomerReportingCheckbox":true,
      ...
      "vtp_enableShippingData":false,
      "vtp_conversionId":"804757827",
      "vtp_conversionLabel":"wNXACPr7u6QCEMPC3v8C",
      "vtp_rdp":false,
      "vtp_url":["macro",4],
      "vtp_enableProductReportingCheckbox":true,
      "vtp_enableNewCustomerReportingCheckbox":true,
      ...
      "vtp_enableShippingData":false,
      "vtp_conversionId":"804757827",
      "vtp_conversionLabel":"1HvFCJThuaQCEMPC3v8C",
      "vtp_rdp":false,
      "vtp_url":["macro",4],
      "vtp_enableProductReportingCheckbox":true,
      "vtp_enableNewCustomerReportingCheckbox":true,
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",1],
      "arg1":"wiri.la\/checkout\/1"
    },{
      "function":"_cn",
      "arg0":["macro",1],
      "arg1":"wiri.la\/checkout\/2"
    },{
      "function":"_cn",
      "arg0":["macro",1],
      "arg1":"wiri.la\/checkout\/3"
    },{
      "function":"_cn",
      "arg0":["macro",1],
      "arg1":"farmacias"
  ...
  "rules":[
    [["if",0],["add",0,14]],
    [["if",1,2],["add",0,53]],
    [["if",2],["add",1,13,14,16,51,120,2,60,61,62,63,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94,95,96,97,100,101,102,103,106,108,109,110,111,112,113,114,115,116,117,118,119]],
    [["if",3,4],["add",3]],
    [["if",4,5],["add",4]],
    [["if",4,6],["add",5]],
    [["if",2,13],["unless",7,8,9,10,11,12],["add",6]],
    [["if",2,14],["add",7,17]],
    [["if",4,15],["add",8]],
    [["if",2,16],["add",9]],
    [["if",2,17],["add",10,12,121]],
    [["if",2,18],["unless",10,19],["add",11]],
    [["if",2,20],["add",15]],
    [["if",4,21],["add",18]],
    [["if",4,22],["add",19]],
    [["if",4,23],["add",20]],
    ...
    [["if",4,9,56],["add",35,39]],
    [["if",4,9,57],["add",35,39]],
    [["if",4,49,58,59,60],["add",36,37]],
    [["if",61,62],["add",40]],
    [["if",63,64],["add",41]],
    [["if",4,65],["add",42]],
    [["if",2,66],["add",43,104]],
    [["if",1,4,67],["unless",9,68],["add",45]],
    [["if",1,4,34],["unless",9,69],["add",45]],
    [["if",4,70],["add",46]],
    [["if",4,71],["add",47]],
    [["if",72,73],["add",48]],
    [["if",72,74],["add",49]],
    [["if",72,75],["add",50]],
    [["if",1,35,76,77],["add",52]],
    [["if",1,2],["unless",7,8,9,10,11,12,78,79,80],["add",54,122]],
    [["if",4],["unless",81],["add",55]],
    [["if",4,82],["add",56]],
    [["if",2,83],["add",57]],
    [["if",2,84],["add",58]],
    [["if",2,85],["add",59]],
    [["if",2,13],["unless",12,78,86,87],["add",99]],
    [["if",2,88],["add",105,107]],
    [["if",2,89],["add",121]]]
},
...
cj:a("respected_consent_types"),Pf:a("setup_tags"),Rf:a("tag_id"),Sf:a("teardown_tags")}}();var Je;
...
Y.h.logging=["google"],function(){function a(){return{}}(function(b){Y.__logging=b;Y.__logging.m="logging";Y.__logging.o=!0;Y.__logging.priorityOverride=0})(function(b){var c=b.vtp_environments||"debug",d=b.vtp_createPermissionError;return{assert:function(e){var f;if(f="all"!==c&&!0){var g=!1;f=!g}if(f)throw d(e,{},"Logging is not enabled in all environments");},T:a}})}();
